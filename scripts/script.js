...
function ans1() {
    ...
    answer.textContent = "Step back and observe the situation for a few minutes. Wait to see if a parent arrives. If the animal is in immediate danger from predator or is in the road, remove the baby and bring to rescue center.";
}
